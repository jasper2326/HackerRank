...
from PMLC.Ch02.logistic_regressor import plot_classifier
...
num_validations = 5
accuracy = model_selection.cross_val_score(classifier_gaussiannb_new,
                                           X, y,
                                           scoring='accuracy',
                                           cv=num_validations)
