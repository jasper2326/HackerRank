...
def build_arg_parser():
    parser = argparse.ArgumentParser(description='Compress the input image using cluster')
    parser.add_argument('--input-file', dest='input_file', required=True, help='Input_image')
...
if __name__ == '__main__':
    ...
    compression_rate = round(100.0 * (8.0 - args.num_bits) / 8.0, 2)
